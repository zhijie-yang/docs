...
-	[`29.4.0-cli`, `29.4-cli`, `29-cli`, `cli`, `29.4.0-cli-alpine3.23`](https://github.com/docker-library/docker/blob/5b2346972dda13a30a936507fd11696296a527ea/29/cli/Dockerfile)

-	[`29.4.0-dind`, `29.4-dind`, `29-dind`, `dind`, `29.4.0-dind-alpine3.23`, `29.4.0`, `29.4`, `29`, `latest`, `29.4.0-alpine3.23`](https://github.com/docker-library/docker/blob/5b2346972dda13a30a936507fd11696296a527ea/29/dind/Dockerfile)
...
To disable this image behavior, simply override the container command or entrypoint to run `dockerd` directly (`... arm32v7/docker:dind dockerd ...` or `... --entrypoint dockerd arm32v7/docker:dind ...`).
...
The `arm32v7/docker` images come in many flavors, each designed for a specific use case.

**Note:** The `arm32v7/docker:stable`, `arm32v7/docker:test`, and related "channel" tags have been deprecated since June 2020 (see [docker-library/docker#179](https://github.com/docker-library/docker/pull/179)) and have not been updated since December 2020 (when Docker 20.10 was released). Suggested alternatives are below. `X` is a placeholder for the version; see the supported tags list for the current set of tags.

-	`arm32v7/docker:stable` ⏩ `arm32v7/docker:latest`, `arm32v7/docker:dind`, `arm32v7/docker:X`, `arm32v7/docker:cli`, etc
-	`arm32v7/docker:test` ⏩ `arm32v7/docker:rc`, `arm32v7/docker:rc-dind`, `arm32v7/docker:X-rc`, `arm32v7/docker:rc-cli`, etc (only updated when there is an active pre-release; will not point to the same thing as `latest`)

## `arm32v7/docker:<version>-cli`
...
## `arm32v7/docker:<version>`, `arm32v7/docker:<version>-dind`
