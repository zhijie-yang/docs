...
-	[`29.4.0-dind-rootless`, `29.4-dind-rootless`, `29-dind-rootless`, `dind-rootless`](https://github.com/docker-library/docker/blob/5b2346972dda13a30a936507fd11696296a527ea/29/dind-rootless/Dockerfile)
...
**Note:** The `arm64v8/docker:stable`, `arm64v8/docker:test`, and related "channel" tags have been deprecated since June 2020 (see [docker-library/docker#179](https://github.com/docker-library/docker/pull/179)) and have not been updated since December 2020 (when Docker 20.10 was released). Suggested alternatives are below. `X` is a placeholder for the version; see the supported tags list for the current set of tags.

-	`arm64v8/docker:stable` ⏩ `arm64v8/docker:latest`, `arm64v8/docker:dind`, `arm64v8/docker:X`, `arm64v8/docker:cli`, etc
-	`arm64v8/docker:test` ⏩ `arm64v8/docker:rc`, `arm64v8/docker:rc-dind`, `arm64v8/docker:X-rc`, `arm64v8/docker:rc-cli`, etc (only updated when there is an active pre-release; will not point to the same thing as `latest`)

## `arm64v8/docker:<version>-cli`
...
## `arm64v8/docker:<version>`, `arm64v8/docker:<version>-dind`
