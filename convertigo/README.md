...
-	[`8.4.1`, `8.4`, `latest`](https://github.com/convertigo/convertigo/blob/fb6f00cdd5842fffb22271230507789e4c565fa4/docker/default/Dockerfile)
...
```console
$ docker run -d --name C8O -e CONVERTIGO_ANONYMOUS_DASHBOARD=true -p 28080:28080 amd64/convertigo
```
...
```console
$ docker run -d –name C8O -e ENABLE_JDWP_DEBUG=true -p 28080:28080 amd64/convertigo
```
