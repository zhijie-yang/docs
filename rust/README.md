...
The `riscv64/rust` images come in many flavors, each designed for a specific use case.

## `riscv64/rust:<version>`
...
## `riscv64/rust:<version>-slim`

This image does not contain the common packages contained in the default tag and only contains the minimal packages needed to run `riscv64/rust`. Unless you are working in an environment where *only* the `riscv64/rust` image will be deployed and you have space constraints, we highly recommend using the default image of this repository.
