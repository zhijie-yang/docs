...
-	[`1-bookworm`, `1.94-bookworm`, `1.94.1-bookworm`, `bookworm`](https://github.com/rust-lang/docker-rust/blob/20c358f05538dc34ab5e2e586bd8f9229c49d51d/stable/bookworm/Dockerfile)

-	[`1-slim-bookworm`, `1.94-slim-bookworm`, `1.94.1-slim-bookworm`, `slim-bookworm`](https://github.com/rust-lang/docker-rust/blob/20c358f05538dc34ab5e2e586bd8f9229c49d51d/stable/bookworm/slim/Dockerfile)

-	[`1-trixie`, `1.94-trixie`, `1.94.1-trixie`, `trixie`, `1`, `1.94`, `1.94.1`, `latest`](https://github.com/rust-lang/docker-rust/blob/20c358f05538dc34ab5e2e586bd8f9229c49d51d/stable/trixie/Dockerfile)
...
-	[`1-alpine3.23`, `1.94-alpine3.23`, `1.94.1-alpine3.23`, `alpine3.23`, `1-alpine`, `1.94-alpine`, `1.94.1-alpine`, `alpine`](https://github.com/rust-lang/docker-rust/blob/20c358f05538dc34ab5e2e586bd8f9229c49d51d/stable/alpine3.23/Dockerfile)
...
The `ppc64le/rust` images come in many flavors, each designed for a specific use case.

## `ppc64le/rust:<version>`
...
## `ppc64le/rust:<version>-slim`

This image does not contain the common packages contained in the default tag and only contains the minimal packages needed to run `ppc64le/rust`. Unless you are working in an environment where *only* the `ppc64le/rust` image will be deployed and you have space constraints, we highly recommend using the default image of this repository.

## `ppc64le/rust:<version>-alpine`
